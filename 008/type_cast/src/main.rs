fn main() {
    ...
    let a: i8 = 1;
    let b: i8 = -1;
    println!("[有符号数] {} 转为[无符号数]: {}, 转换前的二进制为 {:08b}, 转换后的二进制为 {:08b}", a, a as u8, a, a as u8);
    println!("[有符号数] {} 转为[无符号数]: {}, 转换前的二进制为 {:08b}, 转换后的二进制为 {:08b}", b, b as u8, b, b as u8);

    let a: u8 = 1;
    let b: u8 = 255;
    println!("[无符号数] {} 转为[有符号数]: {}, 转换前的二进制为 {:08b}, 转换后的二进制为 {:08b}", a, a as i8, a, a as i8);
    println!("[无符号数] {} 转为[有符号数]: {}, 转换前的二进制为 {:08b}, 转换后的二进制为 {:08b}", b, b as i8, b, b as i8);
    ...
    println!("8位有符号整数 {} 的 转为16位整数的二进制为：{:016b}", b, b as i16);
